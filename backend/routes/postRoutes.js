...
const { createPost, updatePost, getAllUserPost, getYourPost, deletePost, commentPost, likePost, getFriendPost } = require('../controllers/postController');
...
router.post('/getFriendPost',getFriendPost)
